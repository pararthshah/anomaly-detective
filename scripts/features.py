...
from core.naive import find_outliers, index_to_interval, get_anomalies_from_series
...
def create_window_features(values, window_size, feature_func):
    featurelist= list()
    i=0
...
def get_anomalies(path, mul_dev):
    ...
    featurelist= create_window_features(values, 15, f_mean)
